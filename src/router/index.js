...
const routes = [{
		...
		children: [
			...
			// 用户管理
			{
				...
				component: () => import( /* webpackChunkName: "userpage" */ "../views/User/User"),
			},
			// 主页内容管理
			{
				path: "/",
				children: [
					//轮播图管理
					{
						...
						component: () => import( /* webpackChunkName: "lbt" */
					...
					},
					{
						...
						component: () => import( /* webpackChunkName: "dynamic" */
					...
					//主页菜单管理
					{
						...
						component: () => import( /* webpackChunkName: "indexMenu" */
					...
					//集团管理
					{
						...
						component: () => import( /* webpackChunkName: "group" */
					...
					//合作单位管理
					{
						...
						component: () => import( /* webpackChunkName: "cooperation" */
